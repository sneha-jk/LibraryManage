...
public class LibraryController {
	...
	@ResponseBody
	public void saveBook(@RequestParam String bookId,@RequestParam String NoOfBook ,@RequestParam String bookName,@RequestParam String genre,Library obj) {
	
		
		obj.setBookId(bookId);
		obj.setBookName(bookName);
		obj.setGenre(genre);
		obj.setQuantity(NoOfBook);
